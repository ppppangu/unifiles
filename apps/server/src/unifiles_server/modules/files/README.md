...
- adapter.py adapts HTTP and generated DTOs to file behavior.
- service.py contains transport-independent supported-type behavior.
- providers.py defines lightweight object construction.
- router.py statically composes generated routes with application providers.
