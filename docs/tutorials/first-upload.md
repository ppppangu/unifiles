...
3. **Learn About the Three-Layer Architecture**: See the [Developer Tutorial](first-upload.md)
4. **Set Up Production Environment**: Check the [Deployment Guide](../deployment.md)
