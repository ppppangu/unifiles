...
uvicorn unifiles.app.main:app --host 0.0.0.0 --port 8088 --reload

# Or using the Python module
python -m uvicorn unifiles.app.main:app --host 0.0.0.0 --port 8088 --reload
```
...
uvicorn unifiles.app.main:app --port 8088
```
